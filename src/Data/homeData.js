...
export const homeTabData = [
    ...
    cards: [
      {
        ...
        description:
          "The TOMS client is pre-installed, enabling access to the platform instantly when booted.",
      },
      {
        ...
        description:
          "Templates can be used for batch deployments, ensuring fast and uniform terminal setups.",
      },
      {
        ...
        description:
          "Firmware and applications are pre-installed, making deployment quicker and more efficient.",
      },
      {
        ...
        description:
          "Pre-configured settings allow seamless transfers without manual intervention.",
      },
    ],
  },
  {
    ...
    cards: [
      ...
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Multi%20Dimensional/Group.svg",
        title: "Group",
        description:
          "Templates can be used for batch deployments, ensuring fast and uniform terminal setups.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Multi%20Dimensional/Schedule%20Update.svg",
        title: "Scheduled Update",
        description:
          "Firmware and applications are pre-installed, making deployment quicker and more efficient.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Multi%20Dimensional/Single%20Device%20Management.svg",
        title: "Single Device Management",
        description:
          "Pre-configured settings allow seamless transfers without manual intervention.",
      },
    ],
  },
  {
    ...
    cards: [
      ...
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Firmware/Parameter%20Template.svg",
        title: "Parameter Template",
        description:
          "Templates can be used for batch deployments, ensuring fast and uniform terminal setups.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Firmware/Auto%20Run.svg",
        title: "Auto Run",
        description:
          "Firmware and applications are pre-installed, making deployment quicker and more efficient.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Firmware/Kiosk%20Mode.svg",
        title: "Kiosk Mode",
        description:
          "Pre-configured settings allow seamless transfers without manual intervention.",
      },
  ...
  },
  {
    ...
    cards: [
      ...
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Device%20Monitoring/Geo%20Location.svg",
        title: "Geo Location",
        description:
          "Templates can be used for batch deployments, ensuring fast and uniform terminal setups.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Device%20Monitoring/History.svg",
        title: "History",
        description:
          "Firmware and applications are pre-installed, making deployment quicker and more efficient.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Device%20Monitoring/More%20Profile%20Info.svg",
        title: "More Profile Info",
        description:
          "Pre-configured settings allow seamless transfers without manual intervention.",
      },
    ],
  },
  {
    ...
    cards: [
      ...
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Remote%20Assistance/Remote%20Desktop.svg",
        title: "Remote Desktop",
        description:
          "Templates can be used for batch deployments, ensuring fast and uniform terminal setups.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Remote%20Assistance/Extract%20Logs.svg",
        title: "Extract Logs",
        description:
          "Firmware and applications are pre-installed, making deployment quicker and more efficient.",
      },
      {
        img: "http://inatms.s3-website-us-east-1.amazonaws.com/assets/img/Remote%20Assistance/Extract%20Files.svg",
        title: "Extract Files",
        description:
          "Pre-configured settings allow seamless transfers without manual intervention.",
      },
